...
<?php echo CHtml::beginForm(); ?>
	...
	<div class="form-group title">
		...
		<?php echo CHtml::activeTextField($model,'title',array('class'=>'form-control','style'=>'width:250px','size'=>60,'maxlength'=>255)); ?>
	...
	<div class="form-group field_type">
		...
		<?php echo (($model->id)?CHtml::activeTextField($model,'field_type',array('class'=>'form-control','style'=>'width:250px','size'=>60,'maxlength'=>50,'readonly'=>true,'id'=>'field_type')):CHtml::activeDropDownList($model,'field_type',ProfileField::itemAlias('field_type'),array('class'=>'form-control','style'=>'width:250px','id'=>'field_type'))); ?>
	...
	<div class="form-group field_size">
		...
		<?php echo (($model->id)?CHtml::activeTextField($model,'field_size',array('class'=>'form-control','style'=>'width:250px','readonly'=>true)):CHtml::activeTextField($model,'field_size',array('class'=>'form-control','style'=>'width:250px'))); ?>
	...
	<div class="form-group field_size_min">
		...
		<?php echo CHtml::activeTextField($model,'field_size_min',array('class'=>'form-control','style'=>'width:250px')); ?>
	...
	<div class="form-group required">
		...
		<?php echo CHtml::activeDropDownList($model,'required',ProfileField::itemAlias('required'),array('class'=>'form-control','style'=>'width:250px')); ?>
	...
	<div class="form-group range">
		...
		<?php echo CHtml::activeTextField($model,'range',array('class'=>'form-control','style'=>'width:250px','size'=>60,'maxlength'=>5000)); ?>
	...
	<div class="form-group error_message">
		...
		<?php echo CHtml::activeTextField($model,'error_message',array('class'=>'form-control','style'=>'width:250px','size'=>60,'maxlength'=>255)); ?>
	...
	<div class="form-group other_validator">
		...
		<?php echo CHtml::activeTextField($model,'other_validator',array('class'=>'form-control','style'=>'width:250px','size'=>60,'maxlength'=>255)); ?>
	...
	<div class="form-group default">
		...
		<?php echo (($model->id)?CHtml::activeTextField($model,'default',array('class'=>'form-control','style'=>'width:250px','size'=>60,'maxlength'=>255,'readonly'=>true)):CHtml::activeTextField($model,'default',array('class'=>'form-control','style'=>'width:250px','size'=>60,'maxlength'=>255))); ?>
	...
	<div class="form-group widget">
		...
		echo CHtml::activeDropDownList($model,'widget',$widgetsList,array('class'=>'form-control','style'=>'width:250px','id'=>'widgetlist'));
	...
	<div class="form-group widgetparams">
		...
		<?php echo CHtml::activeTextField($model,'widgetparams',array('class'=>'form-control','style'=>'width:250px','size'=>60,'maxlength'=>5000,'id'=>'widgetparams')); ?>
	...
	<div class="form-group position">
		...
		<?php echo CHtml::activeTextField($model,'position',array('class'=>'form-control','style'=>'width:250px')); ?>
