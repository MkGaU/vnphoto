...
<?php $form=$this->beginWidget('CActiveForm'); ?>
	...
	<div class="form-group">
		...
		<?php echo $form->textField($model, 'name', array('maxlength'=>255, 'class'=>'form-control','style'=>'width:250px')); ?>
	...
	<div class="form-group">
		...
		<?php echo $form->textField($model, 'description', array('maxlength'=>255, 'class'=>'form-control','style'=>'width:250px')); ?>
	...
	<?php if( Rights::module()->enableBizRule===true ): ?>
		...
		<div class="form-group">
			...
			<?php echo $form->textField($model, 'bizRule', array('maxlength'=>255, 'class'=>'form-control','style'=>'width:250px')); ?>
	...
	<?php if( Rights::module()->enableBizRule===true && Rights::module()->enableBizRuleData ): ?>
		...
		<div class="form-group">
			...
			<?php echo $form->textField($model, 'data', array('maxlength'=>255, 'class'=>'form-control','style'=>'width:250px')); ?>
